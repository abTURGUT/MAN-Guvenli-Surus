...
public class BireysellRecords2Screen extends AppCompatActivity implements FirebaseInterface {
    ...
    TextView br2s_recordDateTV;
    TextView br2s_notfoundUserTV;
    ListView br2s_listLV;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bireysel_records_2_screen);

        activity = (Activity) this;
        firebaseHelper = new FirebaseHelper((FirebaseInterface)activity);

        br2s_recordDateTV = findViewById(R.id.br2s_recordDateTV);
        br2s_listLV = findViewById(R.id.br1s_listLV);
        br2s_notfoundUserTV = findViewById(R.id.br1s_notfoundUserTV);
